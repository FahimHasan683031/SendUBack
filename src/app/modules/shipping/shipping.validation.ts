...
const insuranceSchema = z.object({
  ...
  productValue: z.number().positive("Product value must be positive").min(100, "Product value must be at least 100").max(1000, "Product value must be less than 1000"),
})
